...
- Deprecated
  ``plasmapy.formulary.collisions.fundamental_electron_collision_freq``. The
  `~plasmapy.formulary.collisions.MaxwellianCollisionFrequencies.Maxwellian_avg_ei_collision_freq`
  attribute of `~plasmapy.formulary.collisions.MaxwellianCollisionFrequencies`
...
- Re-enabled value testing for the ``quantum`` keyword argument in
  `~plasmapy.formulary.collisions.coupling_parameter`. (:pr:`1678`)
